export class TypeZoneManager {
   ...
   * @param {number} offsetY 
   */
  drawTreeZones(context, tileSize, zoom = 1, offsetX = 0, offsetY = 0) {
    const scaledTileSize = tileSize * zoom;
    ...
    // Dessiner seulement les zones de type "tree" visibles
    const treeZones = this.zones.filter(zone => zone.category === 'tree');
